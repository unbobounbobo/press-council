...
元ネタは、Tesla AI責任者・OpenAI創設メンバーだったAndrej Karpathy氏が公開した「LLM Council」。

複数のAIに同じ質問を投げて、お互いの回答を匿名で評価させる。「AIの答えが正しいかわからない」問題を、AI同士の相互チェックで解決しようというツールです。

広報PR業務は、プレスリリース作成をはじめ原稿執筆の機会が多い。こうした相互評価の仕組みが役立つかもしれない。

そう思って魔改造したのが「Press Council」。4つのAIがプレスリリース案を書き、5人の記者AI（日経記者、生活部記者、Web記者など）が「誰が書いたか知らない状態」で評価・ランキング。最後に編集長AIが全ての評価を踏まえて最終版を仕上げます。
